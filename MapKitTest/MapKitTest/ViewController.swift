...
//  MapKitTest
//
//  Created by Владимир Тимофеев on 30.01.2022.
//
...
class ViewController: UIViewController, MKMapViewDelegate {
    ...
    func setCapitals() {
        let london = Capital(title: "London", coordinate: CLLocationCoordinate2D(latitude: 51.507222, longitude: -0.1275), info: "Capital of UK")
        ...
        let washington = Capital(title: "Washington D.C.", coordinate: CLLocationCoordinate2D(latitude: 38.895111, longitude: -77.036667), info: "Capital of US")
